...
export class RestService {
  ...
  updateRelevepluie(relev): Observable<Object> {
    return this.http.put(endpoint + 'updateRelevepluie', relev);
  }

  deleteRelevepluie(id: number): Observable<any> {
    return this.http.delete(endpoint + 'deleteRelevepluie/'  + id, { responseType: 'text' });
  }
